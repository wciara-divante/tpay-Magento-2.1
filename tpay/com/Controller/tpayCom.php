...
abstract class tpayCom extends \Magento\Framework\App\Action\Action {
    ...
    public function getRedirectionFormData($order_id = null)
    {
        ...
        $session_id = $order_id . '|' . uniqid('', true);
        ...
        $data = array(
            ...
            'p24_email' => $order->getCustomerEmail(),
            'p24_amount' => $amount,
...
//            'p24_client' => $order->getBillingAddress()->getData('firstname') . ' ' . $order->getBillingAddress()->getData('lastname'),
//            'p24_address' => $order->getBillingAddress()->getData('street'),
//            'p24_city' => $order->getBillingAddress()->getData('city'),
//            'p24_zip' => $order->getBillingAddress()->getData('postcode'),
            'p24_country' => 'PL',
            'p24_encoding' => 'utf-8',


            'p24_ecommerce' => 'Magento ' . $this->objectManager->get('Magento\Framework\App\ProductMetadata')->getVersion(),
